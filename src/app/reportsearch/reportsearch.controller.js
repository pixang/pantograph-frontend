...
module.controller("ReportSearchController", ['$scope', '$state', '$rootScope', '$timeout', '$mdpDatePicker', '$mdpTimePicker', 'Alert', '$uibModal', 'ReportSearchService', 'constants',
    function ($scope, $state, $rootScope, $timeout, $mdpDatePicker, $mdpTimePicker, $alert, $modal, reportSearchService, $const) {
        ...
        // checkbox
        $scope.items = ['磨耗', '中心偏移', '温度', '羊角'];
        $scope.itemsTransfer = [1, 2, 3, 4];
        ...
        $scope.search = function () {
            ...
            searchCondition.selectType = $scope.selected.length !== 0 ? $scope.selected : [];
...
// module.controller('SixImageController', [
//     '$scope', '$state', '$rootScope', '$timeout', '$uibModalInstance', '$uibModal', 'Alert', 'trainOnlyId','archNum','DrivingTableService',
//     function ($scope, $state, $rootScope, $timeout, $modalInstance,$modal,$alert, trainOnlyId, archNum,drivingTableService) {
//
//         //         //
//         $scope.form = {
//             isLoaded: false,
...
//                         return
//                     }
//                     $scope.imageAddrs = data.imageAddrs.map(function (item, index, array) {
//                         return "http://192.168.1.103:8080/Downloads/assets" + item;
//                     });
//                     $scope.form.setLoading(false);
