...
(function () {
    ...
    t.e = function (a, c) {
        ...
        c.innerHTML || (this.u = u.e("div", {className: "vjs-control-content"}), this.xb = u.e("span", {
    ...
    t.update = function () {
        if (this.b) {
            var a, c = this.Db(), d = this.handle, e = this.ad;
            isNaN(c) && (c = 0);
            a = c;
            if (d) {
    ...
    u.qa.prototype.va = function () {
        var a = new u.ga(this.c, {lc: "div"}), c = new u.ob(this.c, u.l.B({Wd: f}, this.j.me));
        a.V(c);
        return a
    };
    ...
    u.i = u.t.extend({
        h: function (a, c, d) {
            ...
            var k = u.l.B({
                    ...
                    loop: a.loop,
                    muted: a.muted
                }, c.flashVars), p = u.l.B({wmode: "opaque", bgcolor: "#000000"}, c.params),
                n = u.l.B({id: h, name: h, "class": "vjs-tech"}, c.attributes), s;
    ...
    u.U.prototype.ua = function () {
        ...
        for (var d = 0; d < this.c.textTracks().length; d++) c = this.c.textTracks()[d], c.K() === this.H && a.push(new u.Z(this.c, {track: c}));
        return a
    };
    u.Fa = u.U.extend({
        h: function (a, c, d) {
    ...
    t.ua = function () {
        for (var a = [], c, d = 0; d < this.c.textTracks().length; d++) c = this.c.textTracks()[d], c.K() === this.H && a.push(new u.Z(this.c, {track: c}));
        return a
    };
    t.va = function () {
        for (var a = this.c.textTracks(), c = 0, d = a.length, e, g, h = this.O = []; c < d; c++) if (e = a[c], e.K() == this.H && e.Qa()) {
            if (2 > e.readyState()) {
                this.be = e;
